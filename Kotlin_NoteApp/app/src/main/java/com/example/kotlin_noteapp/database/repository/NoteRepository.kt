package com.example.kotlin_noteapp.database.repository

import android.app.Application
import androidx.lifecycle.LiveData
import com.example.kotlin_noteapp.database.dao.NoteDao
import com.example.kotlin_noteapp.database.NoteDatabase
import com.example.kotlin_noteapp.model.Note

class NoteRepository(app:Application) {
    private val noteDao:NoteDao
    init {
        val noteDatabase: NoteDatabase = NoteDatabase.getInstace(app)
